...
import { 
  IndianRupee, Search, Filter, Eye, RefreshCw, Download,
  CreditCard, CheckCircle, XCircle, Clock, TrendingUp, AlertTriangle
} from "lucide-react";
  ...
  const refunds = [
    {
      id: "REF-001",
      customer: "Jane Doe",
      originalAmount: 10080.00,
      refundAmount: 10080.00,
    ...
    },
    {
      id: "REF-002",
      customer: "Bob Wilson",
      originalAmount: 7182.00,
      refundAmount: 3591.00,
      ...
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm">
          ...
          <div className="col-span-2">
            ...
            <p className="font-bold text-lg text-accent">₹{method.revenue.toLocaleString()}</p>
          </div>
        </div>
      </CardContent>
    </Card>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Monitor transactions and payments</p>
          </div>
          <div className="flex gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-accent">₹{transactions.reduce((sum, t) => sum + t.amount, 0).toLocaleString()}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-secondary">{pendingTransactions.length}</p>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-destructive">{failedTransactions.length}</p>
