  ...
  const tickets = [
    {
      ...
      description:
        "Fuel delivery was scheduled for 2 PM but driver never showed up. Need immediate assistance.",
    },
    {
      id: "TIC-002",
      ...
      description:
        "I was charged twice for the same service. Can you help me understand my bill?",
    },
    {
      id: "TIC-003",
      ...
      description:
        "The mobile app keeps crashing when I try to place an order.",
    },
    {
      id: "TIC-004",
      ...
      description:
        "Great service! Just wanted to leave positive feedback for the mechanic.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "You can track your delivery in real-time using our mobile app or website. You'll receive notifications when your driver is on the way.",
      category: "Delivery",
      views: 245,
      helpful: 89,
    },
    {
      ...
      answer:
        "We accept all major credit cards, debit cards, Apple Pay, Google Pay, and PayPal for your convenience.",
      category: "Payment",
      views: 189,
      helpful: 76,
    },
    {
      ...
      answer:
        "You can cancel your appointment up to 2 hours before through the app or by calling support.",
