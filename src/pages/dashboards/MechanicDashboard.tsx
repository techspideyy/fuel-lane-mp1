...
const MechanicDashboard = () => {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      setAuthState({ loading: false, role: user.role });
    };
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <Button
                ...
                variant="outline"
                onClick={() => navigate("/dashboard/mechanic/inventory")}
              >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="hover:shadow-medium transition-shadow cursor-pointer group">
          <CardContent className="p-6 text-center">
            ...
            <Button className="w-full" onClick={() => navigate("/dashboard/mechanic/appointments")}>
              View Schedule
            </Button>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-medium transition-shadow cursor-pointer group">
          <CardContent className="p-6 text-center">
            ...
            <Button
              variant="outline"
              className="w-full"
              onClick={() => navigate("/dashboard/mechanic/services")}
            >
              Manage Services
            </Button>
          </CardContent>
